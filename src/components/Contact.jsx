    ...
    <div id="contact" className="bg-[#ffffff] min-h-screen flex items-center justify-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        <div className="text-center">
          ...
          Feel free to reach out to me for collaboration or cybersecurity discussions Via LinkedIn or Email.
          ...
          <div className="flex flex-col space-y-5 text-lg md:text-xl font-semibold">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="https://www.linkedin.com/in/sanjay-krishna-ob-b7ab132b2/"
                  className="hover:text-[#fe5617]"
                >
                  <FaLinkedin size={29} />
                </a>
